...
check_token() {
  echo -e "                                                       "
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "${BLUE}[+]               LICENSY FAREL SILENCE            [+]${NC}"
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "                                                       "
  echo -e "${YELLOW}MASUKAN AKSES TOKEN :${NC}"
  read -r USER_TOKEN

  if [ "$USER_TOKEN" = "kamunanya25" ]; then
    echo -e "${GREEN}AKSES BERHASIL${NC}}"
  else
    echo -e "${GREEN}Buy dulu Gih Ke Farel Silence${NC}"
    echo -e "${YELLOW}WHATSAPP : 6282181669356${NC}"
    echo -e "${YELLOW}HARGA TOKEN : 20K FREE UPDATE${NC}"
    echo -e "${YELLOW}©Farel Silence${NC}"
    exit 1
  fi
  clear
}
...
while true; do
  ...
  echo -e "${BLUE}'ggg      ,gg'''  .    ggg       Auto Installer Farel Silence Private   ${NC}"
  echo -e "${BLUE}gggg      gg     ,     ggg      ------------------------  ${NC}"
  echo -e "${BLUE} ggg:     ggg._    _,ggg        • Creadit  : Farel Silence ${NC}"
  echo -e "${BLUE} ggg.    '.'''ggggggp           • Support by Farel Silence  ${NC}"
